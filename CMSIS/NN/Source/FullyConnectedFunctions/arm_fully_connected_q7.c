...
arm_status
arm_fully_connected_q7_div(const q7_t * pV,
                       const q7_t * pM,
                       const uint16_t dim_vec,
                       const uint16_t num_of_rows,
                       const uint16_t bias_shift,
                       const float out_div, const q7_t * bias, q7_t * pOut, q15_t * vec_buffer)
{
...
//    	STLBLE_PRINTF("%d,", rowCnt);
        ...
        *pO++ = (q7_t) (__SSAT(round(sum / out_div), 8));
        *pO++ = (q7_t) (__SSAT(round(sum2 / out_div), 8));
...
arm_status
arm_fully_connected_q7_o32(const q7_t * pV,
                       	   const q7_t * pM,
						   const uint16_t dim_vec,
						   const uint16_t num_of_rows,
						   const uint16_t bias_shift,
						   const uint16_t out_shift, const q7_t * bias, q7_t * pOut, q15_t * vec_buffer, q31_t * pOut32)
{
